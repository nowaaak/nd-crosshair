...
public sealed class ConfigStore
{
    ...
    private static string Serialize(AppConfig config) => JsonSerializer.Serialize(config.Normalize(), JsonDefaults.Indented);

    private static AppConfig Deserialize(string json) =>
        (JsonSerializer.Deserialize<AppConfig>(json, JsonDefaults.Indented)
